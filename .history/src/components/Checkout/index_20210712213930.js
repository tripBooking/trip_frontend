...
export default class index extends Component {
    ...
    render() {
        ...
        const scheme = yup.object().shape({
            fname: yup.string().required('Name on card is required').matches(nameRegex,'must only contain letters').min(2),
            lname: yup.string().required('Name on card is required').matches(nameRegex, 'must only contain letters').min(2),
